        ...
        >
          ...
          >
            ...
            <div>
              <DeleteBulk
                v-if="
                  data.selectedId.length != 0 && can(['delete outgoing_mail'])
                "
                :selectedId="data.selectedId"
              />
              <!-- <Create
                :sub_types="props.sub_type"
                :unit="props.detail_department"
          ...
          <div class="flex-auto px-5 pt-0 pb-2">
            <div class="p-0 overflow-x-auto">
              ...
              >
                ...
                <tbody>
                  <tr
                    v-for="(Outgoing_mail, index) in props.outgoing_mail.data"
                    :key="index"
                  ...
                  >
                    ...
                    >
                      ...
                      ></Verifikasi>
                      <Tracking :outgoing_mail="Outgoing_mail" />
                      <!-- <a
              ...
              <Pagination :links="props.outgoing_mail" :filters="data.params" />
            </div>
          </div>
        </div>
      </div>
