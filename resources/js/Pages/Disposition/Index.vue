...
watch(
    ...
    debounce(() => {
        ...
        router.get(route("disposition.index"), param, {
            replace: true,
            preserveState: true,
            preserveScroll: true,
        });
    ...
    <AuthenticatedLayout>
        <div class="flex flex-wrap -mx-3">
            <div class="mx-auto w-full sm:px-6 lg:px-8 space-y-6 py-12">
                ...
                >
                    <div class="text-xl font-bold px-3 py-4">Disposisi</div>
                    <div
                    ...
                    <div class="flex-auto px-5 pt-0 pb-2">
                        <div class="p-0 overflow-x-auto">
                            ...
                            >
                                ...
                                <tbody>
                                    <tr
                                        v-for="(externalMail, index) in props
                                            .externalMail.data"
                                        :key="index"
                                    ...
                                    >
                                        ...
                                        <td
                                            class="py-2 pr-12 align-middle bg-transparent dark:border-0 whitespace-nowrap shadow-transparent text-center"
                                        >
                                            <span class="text-sm">{{
                                        ...
                                        <td>
                                            <template
                                                v-if="
                                                    externalMail.status == '0'
                                                "
                                            >
                                                <span
                                                    class="py-1.4 px-2.5 text-xs rounded-1.8 inline-block whitespace-nowrap text-center bg-gradient-to-tl from-yellow-500 to-yellow-500 align-baseline font-bold uppercase leading-none text-white"
                                                    >On Progress</span
                                                >
                                            </template>
                                            <template v-else>
                                                <a
                                                    ...
                                                    :href="
                                                        route(
                                                            'export.externalMailDisposition',
                                                            [externalMail.id]
                                                        )
                                                    "
