  ...
  <Modal :show="isModalEditOpen" @close="closeModal" maxWidth="4xl">
    <div class="mb-5 mx-6">
      ...
      <p class="text-sm mt-2">
        Dokumen / surat terlampir telah diperiksa dan diteliti secara hierarki
        serta diparaf oleh para pejabat terkait yang bertanggung jawab, untuk
        selanjutnya diteruskan kepada
        <b>{{ props.outgoing_mail.sign_user }}</b> untuk ditandatangani.
      </p>
    </div>
            ...
            >
              ...
              >
                <div class="flex px-2 py-1">
                  <div class="flex flex-col justify-center">
                    <h6 class="mb-0 text-xs leading-normal dark:text-white">
                      {{ tracking.to.detail_department.title }}
                    </h6>
                  </div>
                </div>
              </td>
                ...
                <div class="flex px-2 py-1">
                  <div class="flex flex-col justify-center">
                    <h6
                      ...
                      :class="{
                        'text-green-400': tracking.status == 1,
                        'text-red-400': tracking.status == 0,
                        'text-blue-400': tracking.status == 2,
                      }"
                    >
                      {{
                        tracking.status == 1
              ...
              >
                <div class="flex px-2 py-1">
                  <div class="flex flex-col justify-center">
                    <h6 class="mb-0 text-xs leading-normal dark:text-white">
                      {{
                        tracking.read_at ? tracking.read_at : "Belum Di Baca"
                      }}
                    </h6>
                  </div>
                </div>
