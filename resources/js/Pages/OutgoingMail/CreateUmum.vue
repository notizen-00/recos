  ...
  <Modal :show="isModalOpen" @close="closeModal" maxWidth="4xl">
    ...
    <form @submit.prevent="createNewUnit" class="m-5">
      ...
      <div class="mt-2">
        ...
        <QuillEditor v-model:content="form.content" @update:content="(content) => form.content = content"
                     contentType="html" theme="snow" style="min-height: 120px"/>
      ...
      <div class="w-full flex justify-between mt-2">
        <div class="w-1/2">
          ...
          ></multiselect>
          <InputError class="mt-2" :message="form.errors.org_subject_id"/>
        </div>
        <div class="w-1/2">
          <InputLabel
              for="Dikirim Ke"
