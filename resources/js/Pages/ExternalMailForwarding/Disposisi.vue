...
import {ref} from "vue";
import {getChildrenDepartmentHirarki} from "@/services/hirarki.js";
...
const form = useForm({
  external_mail_id: props.externalMail.id,
  recipients: [],
  follow_up_type: "",
  follow_up_message: ""
});
...
const buildRecipientList = getChildrenDepartmentHirarki(
    props.userDepartment,
    usePage().props.auth.detail_department.id,
    null
)
...
<template>
  ...
  <Modal :show="isModalOpen" @close="closeModal" maxWidth="4xl">
    ...
    <form @submit.prevent="createNewDisposition" class="m-5">
      <div class="w-full flex justify-between mt-2">
        <div class="w-1/2">
          ...
          <TextInput
              ...
              v-model="props.externalMail.agenda_number"
          />
        </div>
        <div class="w-1/2 pl-3">
          ...
          <TextInput
              ...
              class="mt-1 cursor-not-allowed block w-1/2"
              v-model="props.externalMail.agenda_date"
          />
        </div>
      </div>
      <div class="w-full flex justify-between mt-2">
        <div class="w-1/2">
          ...
          <TextInput
              ...
              class="mt-1 cursor-not-allowed block w-1/2"
              v-model="props.externalMail.letter_number"
          />
        </div>
        <div class="w-1/2 pl-3">
          ...
          <TextInput
              ...
              class="mt-1 cursor-not-allowed block w-1/2"
              v-model="props.externalMail.letter_date"
          />
        </div>
      </div>
      <div class="mt-2">
        ...
        <TextInput
            ...
            type="text"
            class="mt-1 cursor-not-allowed block w-1/2"
            v-model="props.externalMail.subject"
            autofocus
      ...
      <div class="w-full flex justify-between mt-2">
        <div class="w-1/2">
          <div v-for="recipient in recipientList" :key="recipient.id" class="mt-2">
