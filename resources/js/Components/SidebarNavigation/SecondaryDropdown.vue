...
<template>
    <div>
        <a
            ...
            :class="[
                'py-2.5 px-4 pl-6 ml-1 mt-0.75 rounded-2  flex items-center text-sm transition-all',
                isExpanded
        ...
        <div
            ...
            class="overflow-scroll pl-7 mt-0.75 transition-all duration-300 ease-in-out"
        >
            <ul class="list-none">
