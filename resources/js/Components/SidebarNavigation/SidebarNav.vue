...
const activeClasses = computed(() => [
    ...baseClasses,
    isActive.value
        ? "bg-blue-500/30 text-slate-700 dark:text-white"
        : "text-slate-700/50 dark:text-white/50",
]);
...
<template>
    <li class="mt-0.5 w-full">
        ...
        >
            ...
            <!-- Title -->
            <span
                class="ml-1 duration-300 opacity-100 pointer-events-none ease text-slate-700 dark:text-white"
            >
                {{ title }}
            </span>
        </a>
        ...
        >
            <ul
                class="flex flex-wrap mb-0 ml-6 list-none transition-all duration-200 ease-in-out"
            >
                        ...
                        <a
                            ...
                            :class="[
                                ...
                                isItemActive(item)
                                    ...
                                    : 'text-slate-800/50 dark:text-white/60',
                            ]"
                            :aria-expanded="isParentExpanded"
                        >
                            <span
                                class="w-0 text-center transition-all duration-200 ease-in-out opacity-0 pointer-events-none"
                            >
                                {{ item.name.charAt(0) }}
                            </span>
                            <span
                                class="transition-all duration-100 pointer-events-none ease"
                            >
                                {{ item.name }}
                            </span>
                        </a>
