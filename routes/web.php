...
Route::middleware('auth')
    ->group(function () {
        ...
        Route::resource('/external-mail', ExternalMailController::class)
            ->except('create', 'edit');
...
Route::prefix('export')
    ...
    ->group(function () {
        Route::get('/tte/{mailModel}/{mailId}', 'tte')
            ->name('tte');
        Route::get('/umum/{outgoingMailId}', 'umum')
            ->name('umum');
        Route::get('/external-mail-disposition/{mailId}', 'externalMailDisposition')
            ->name('externalMailDisposition');
        Route::get('/{mailModel}/{mailId}', 'show')
            ->name('show');
    });
